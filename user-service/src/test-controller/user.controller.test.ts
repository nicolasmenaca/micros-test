...
describe("UserController", () => {
    ...
    it("busca por email y lo encuentra", async () => {
        const req = { params: { email: "juan@example.com" } } as any;
        const res = mockResponse();
    ...
    it("busca por email y no lo encuentra", async () => {
        const req = { params: { email: "notfound@example.com" } } as any;
        const res = mockResponse();
    ...
    it("actualiza un usuario", async () => {
        const req = { params: { id: "1" }, body: { nombre: "Juan actualizado" } } as any;
        const res = mockResponse();
